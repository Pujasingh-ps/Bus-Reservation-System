function send(method,url,post='',callback){
  ...
  function removebus(text){
    if(text=='1'){
        ...
        document.getElementsByClassName('msg')[1].innerHTML = "cannot remove";
    }
    setTimeout(function(){
  ...
  add.addEventListener('click',function(){
    if(busnumber.value==''||source.value==''||destination.value==''){
      document.getElementsByClassName('msg')[0].innerHTML='All field must be filled';
      setTimeout(function(){
        document.getElementsByClassName('msg')[0].innerHTML='';
      },1000);
      return ;
 ...
 remove.addEventListener('click',function(){
  if(inputs[3].value==''){
    document.getElementsByClassName('msg')[1].innerHTML='All field must be filled';
    setTimeout(function(){
      document.getElementsByClassName('msg')[1].innerHTML='';
    },1000);
    return ;
